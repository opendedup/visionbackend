...
def print_value_node(node, level):
    ...
    try:
        ...
        print("v {}".format(node_value.GetName()))
        ...
        # Print value
        print_with_indent(level, '%s: %s %s' % (display_name, value,'value'))
...
def print_string_node(node, level):
    ...
    try:
        ...
        print_with_indent(level, '%s: %s %s' % (display_name, value,'string'))
...
def print_integer_node(node, level):
    ...
    try:
        ...
        # Print value
        print_with_indent(level, '%s: %s %s' % (display_name, value,'integer'))
...
def print_float_node(node, level):
    ...
    try:
        ...
        # Print value
        print_with_indent(level, '%s: %s %s' % (display_name, value,'float'))
...
def print_boolean_node(node, level):
    ...
    try:
        ...
        print_with_indent(level, '%s: %s %s' % (display_name, value,'boolean'))
...
def print_enumeration_node_and_current_entry(node, level):
    ...
    try:
        ...
        print_with_indent(level, '%s: %s %s' % (display_name, entry_symbolic,'enum'))
