...
def write_saved_model_server(saved_model_path,
...
def _export_inference_graph(input_type,
                            ...
                            input_shape=None,
                            optimize_graph=True,
                            output_collection_name='inference_op',tf_serving=False):
  """Export helper."""
  ...
  frozen_graph_def = freeze_graph_with_def_protos(
      ...
      output_graph=trained_checkpoint_prefix,
      clear_devices=True,
      initializer_nodes='')
  #_write_frozen_graph(frozen_graph_path, frozen_graph_def)
  if tf_serving:
      write_saved_model_server(saved_model_path, trained_checkpoint_prefix,
...
def export_inference_graph(input_type,
                           ...
                           optimize_graph=True,
                           output_collection_name='inference_op',
                           additional_output_tensor_names=None,tf_serving=False):
  ...
  _export_inference_graph(input_type, detection_model,
                          ...
                          input_shape, optimize_graph, output_collection_name,tf_serving)
